...
func BranchOp(loc mlir.Location, dest mlir.Block, operands ...mlir.Value) (*mlir.OwnedOperation, error) {
	if dest.IsNull() {
...
func CondBranchOp(ctx *mlir.Context, loc mlir.Location, cond mlir.Value, trueDest mlir.Block, trueOperands []mlir.Value, falseDest mlir.Block, falseOperands []mlir.Value) (*mlir.OwnedOperation, error) {
	if cond.IsNull() {
