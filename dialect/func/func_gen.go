...
func FuncOp(ctx *mlir.Context, loc mlir.Location, name string, functionType mlir.Type, body *mlir.OwnedRegion) (*mlir.OwnedOperation, error) {
	if name == "" {
...
func CallOp(ctx *mlir.Context, loc mlir.Location, callee string, results []mlir.Type, operands ...mlir.Value) (*mlir.OwnedOperation, error) {
	if callee == "" {
...
func ReturnOp(loc mlir.Location, values ...mlir.Value) (*mlir.OwnedOperation, error) {
